 ...
 * All icons scale via the `size` prop (default 20).
 * This eliminates dependency on low-res .png assets.
 */

const Icons = {};

// ─── Default SVG wrapper ───
const SVG = ({ size = 20, className = '', viewBox = '0 0 24 24', children }) => (
  <svg
...
Icons.GitHub = ({ size = 20, className = '' }) => (
...
Icons.ExternalLink = ({ size = 20, className = '' }) => (
  <SVG size={size} className={className}>
    <path d="M15 3h6v6" />
    <path d="M10 14 21 3" />
...
Icons.Layers = ({ size = 20, className = '' }) => (
  <SVG size={size} className={className}>
...
Icons.Database = ({ size = 20, className = '' }) => (
  <SVG size={size} className={className}>
...
Icons.Cpu = ({ size = 20, className = '' }) => (
  <SVG size={size} className={className}>
    <rect width="16" height="16" x="4" y="4" rx="2" />
    <rect width="6" height="6" x="9" y="9" rx="1" />
    <path d="M15 2v2M15 20v2M2 15h2M20 15h2M15 2v2M9 2v2M2 9h2M20 9h2M9 20v2M2 9h2M20 9h2" />
  </SVG>
);

Icons.Book = ({ size = 20, className = '' }) => (
  <SVG size={size} className={className}>
    <path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a2.5 2.5 0 0 1 0-5H20" />
  </SVG>
);

Icons.ArrowRight = ({ size = 20, className = '' }) => (
  <SVG size={size} className={className}>
    <path d="M5 12h14" />
...
Icons.ArrowUpRight = ({ size = 16, className = '' }) => (
  <SVG size={size} className={className}>
    <path d="M7 7h10v10" />
    <path d="M7 17 17 7" />
  </SVG>
...
Icons.ChevronDown = ({ size = 18, className = '' }) => (
  <SVG size={size} className={className}>
    <path d="m6 9 6 6 6-6" />
  </SVG>
);

Icons.Trophy = ({ size = 20, className = '' }) => (
  <SVG size={size} className={className}>
...
Icons.Star = ({ size = 20, className = '' }) => (
  <SVG size={size} className={className}>
    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
  </SVG>
);

Icons.Zap = ({ size = 20, className = '' }) => (
  <SVG size={size} className={className}>
    <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />
  </SVG>
);

Icons.Briefcase = ({ size = 20, className = '' }) => (
  <SVG size={size} className={className}>
...
Icons.GraduationCap = ({ size = 20, className = '' }) => (
  <SVG size={size} className={className}>
...
Icons.FileText = ({ size = 20, className = '' }) => (
  <SVG size={size} className={className}>
...
Icons.FolderOpen = ({ size = 20, className = '' }) => (
  <SVG size={size} className={className}>
    <path d="m6 14 1.5-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.54 6a2 2 0 0 1-1.95 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H18a2 2 0 0 1 2 2v2" />
  </SVG>
);

Icons.Codeforces = ({ size = 20, className = '' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
